...
const Call = () => {
  ...
  return (
    <div className={`callback-bt ${isHovered ? 'hovered' : ''}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}  >
      <div className={`text-call ${isHovered ? 'hovered' : ''}`} onTouchStart={() => {isHovered ? handleMouseLeave() : handleMouseEnter()}}>
